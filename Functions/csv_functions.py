...
def getrow(csvfile,rowno = 1):
	'''
	Extract a row based on row number
	'''
...
def getrow_from_rowName(csvfile, rowname =""):
	'''
	Extract a row based on row name
	'''
...
def getcol(csvfile, colno =1):
	'''
	Extract a column based on column number
	'''
...
def getcol_from_colName(csvfile, colname = ""):
	'''
	Extract a column based on column name
	'''
...
def getval_rowcol(csvfile, rowno = 1, colno=1):
	'''
	Extract data based on row and column number
	'''
...
def getval_rowName_colName(csvfile, rowname = "", colname =""):
	'''
	Extract data based on row and column name
	'''
